...
{
	header("Location: http://ec2-34-211-115-232.us-west-2.compute.amazonaws.com/google/viewaccount.php");
}
?>
<!DOCTYPE html>
<html>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container w3-text-grey" id="New Arrivals">
    <p>6 items</p>
  </div>

<h1 align="left">New Arrivals </h1>
...
function strip_tag($string)
{
	...
	$con = mysqli_connect("localhost","root","Passw0rd!","demos");
	//if (mysql_errno())
	//{
