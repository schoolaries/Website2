...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container w3-text-grey" id="vodka">
  </div>

<h1 align="left">Vodka </h1>
...
<!-- Products List Start -->
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_desc, product_img_name, price FROM products WHERE product_name LIKE '%vodka%' ORDER BY id ASC");
if($results){ 
