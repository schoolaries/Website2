...
{
	header("Location: https://ec2-34-211-115-232.us-west-2.compute.amazonaws.com/google/home.php");
}
?>
  ...
  <form method=POST action="" name="user">
	<table border=0>
		<tr>
			...
			<td>
					<button type="submit" class="w3-btn w3-red" value="yes" name="user">Search User</button>
			</td>
		</tr>
