...
if(!isset($_SERVER['HTTPS'])){
	header("Location: https://ec2-34-211-115-232.us-west-2.compute.amazonaws.com/google");
	die();
}
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container w3-text-grey" id="glenlivet">
  </div>

<h1 align="left">Glenlivets </h1>
...
<!-- Products List Start -->
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_desc, product_img_name, price FROM products WHERE product_name LIKE '%glenlivet%' ORDER BY id ASC");
if($results){ 
